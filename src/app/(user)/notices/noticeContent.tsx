...
function NoticesContent({ notices }: NoticesContentProps) {
  ...
  {/* Main Notice Content */}
  <div className="w-[70%] h-full bg-gray-50 p-6">
    {selectedNotice ? (
        ...
        {selectedNotice.imageUrl && (
          <div className="mb-6 flex justify-center items-center">
            ...
            height={400}
              ...
              className="w-4/5 rounded-lg object-cover shadow-md"
            />
          </div>
        )}

        {/* Content */}
        <div className="flex items-center justify-center w-full px-20 text-xl text-gray-700">
  ...
  {/* Sidebar Notices */}
  <div className="w-[30%] bg-gray-100 h-full border-l shadow-md p-4">
