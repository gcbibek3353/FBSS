            ...
            >
              ...
              <div className="p-5 text-center">
                ...
                <div className="flex justify-center items-center mt-3 space-x-4">
                  <Link href={member.fbLink} className=" bg-gray-300 rounded-full text-center p-2 hover:text-blue-800">
                     <Facebook />
                  </Link>
                  <p className="text-gray-700 flex items-center">
                    <span className="mr-1 bg-gray-300 rounded-full text-center p-2 hover:text-blue-800 cursor-pointer" ><Phone/></span>
